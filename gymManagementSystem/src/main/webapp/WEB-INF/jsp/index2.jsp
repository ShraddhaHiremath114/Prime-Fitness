...
<div class="content">
  ...
  <div class="text-content">
    <h1><span>ACHIEVE YOUR FITNESS GOALS</span></h1>
    <h1><span>WITH EXPERT GUIDANCE</span></h1>
    <h1><span class="yellow">AND DEDICATION</span></h1>
    <p>Join us to embark on a transformative journey towards a stronger, healthier you. Let's unlock your potential together.</p>
    <div class="btn-container">
      <button class="btn-get-started">JOIN NOW</button>
    </div>
</div>
